        ...
        <div style="margin-top: 50px; margin-left: 30px">
            ...
            <div>
                <form action="add-user" method="post" id="commit_user" onsubmit="return commitUser()">
                    ...
                    <div>
                        <span>用&nbsp;&nbsp;户&nbsp;&nbsp;名：</span><input name="username" type="text" required><span> *</span><span style="color: red">${username_error}</span><br />
                        <span>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</span><input name="password" id="password" type="password" required><span> *</span><br />
                        <span>确认密码：</span><input id="password_confirm" type="password" required><span> *</span><span id="confirm_error" style="color: red"></span><br />
                        <span>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</span><input name="remark" type="text">
                    </div>
                    <input id="commit_user_btn" type="submit" value="提交">${add_user_success}
                </form>
            </div>
        </div>
        <!--addUser-end-->
