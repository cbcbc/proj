        ...
        <div class="manager_module">
            ...
            <div>
                订单查询：<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <input type="button" id="submit_view_btn" value="提交查询">
            </div>
            <br />
            ...
            <div id="pages">
                <ul>
                    <li class="page_select"><a href="view-order?pageId=0&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}>首页</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
                    <li class="page_select">
                        <c:choose>
                            <c:when test="${pageId == 0}">
                                <a href="view-order?pageId=${pageId }&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:when>
                            <c:otherwise>
                                <a href="view-order?pageId=${pageId-1 }&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:otherwise>
                        </c:choose>
                    </li>
                    <li class="page_select">
                        <a href="view-order?pageId=${pageId}&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}" class="current_page">${pageId + 1}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    </li>
                    <c:forEach begin="2" end="5" var="i">
                        <li class="page_select">
                            <c:choose>
                                <c:when test="${pageId + i <= pageNumbers}">
                                    <a href="view-order?pageId=${pageId + i - 1}&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">${pageId + i}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                </c:when>
                            </c:choose>
                        </li>
                    </c:forEach>
                    <li class="page_select">
                        <c:choose>
                            <c:when test="${pageId==pageNumbers-1}">
                                <a href="view-order?pageId=${pageId }&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:when>
                            <c:otherwise>
                                <a href="view-order?pageId=${pageId+1 }&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:otherwise>
                        </c:choose>
                    </li>
                    <li class="page_select"><a href="view-order?pageId=${pageNumbers-1 }&orderIdQuery=${orderIdQuery}&startTime=${startTime}&overTime=${overTime}&orderStatusQuery=${orderStatusQuery}">尾页</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
